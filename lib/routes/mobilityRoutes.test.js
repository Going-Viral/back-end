...
describe('mobility data', () => {
  ...
  it('7 fetches all data for a single subregion1, including subregion2s by Date', 
    () => {
      const countryCode = 'US';
      const subRegion1 = '';

      return request(app)
        .get(`/api/v1/mobility/subRegionWithDate/${countryCode}/${subRegion1}/2020-02-15T00:00:00.000+00:00/test`)
        .then(res => {
