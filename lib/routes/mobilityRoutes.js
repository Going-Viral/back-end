...
// 6: fetch all data for a single subregion1, including subregion2s
  ...
  // 7: fetch all data for a single subregion1, including subregion2s by Date
  .get('/subRegionWithDate/:countryCode/:subRegion1/:date', (req, res, next) => {
    MobilityData
      .find({
        date: req.params.date,
        countryCode: req.params.countryCode,
  ...
  .get('/subRegionWithDate/:countryCode/:subRegion1/:date/test', (req, res, next) => {
    TestMobilityData
      .find({
        date: req.params.date,
        countryCode: req.params.countryCode,
